	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(_reactRouter.Route, { path: 'me', component: _MeContainer2.default })
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(240)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function barsList() {
	    ...
	    switch (action.type) {
	        case _actions.SEARCH_TERM:
	            return Object.assign({}, state, {
	                term: action.term,
	                isFetching: true
	            });
	        case _actions.ADD_BARS:
	            return Object.assign({}, state, {
	                bars: action.bars,
	                updated: 'yes updated',
	                isFetching: false
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addBars = exports.addBars = function addBars(bars) {
	    return {
	        type: ADD_BARS,
	        bars: bars
	    };
	...
	var addUsername = exports.addUsername = function addUsername(username) {
	    return {
	        type: ADD_USERNAME,
	        username: username
	    };
	...
	var removeBarAJAX = exports.removeBarAJAX = function removeBarAJAX(barId) {
	    return function (dispatch) {
	        return (0, _isomorphicFetch2.default)(window.location.protocol + '//' + window.location.host + '/removebar', {
	            headers: {
	                'Content-Type': 'application/json'
	            },
	...
	var removeBar = exports.removeBar = function removeBar(barId) {
	    return {
	        type: REMOVE_BAR,
	        barId: barId
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarsList = function (_React$Component) {
	    ...
	    function BarsList(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(BarsList).call(this, props));
	    }
	                    ...
	                    return _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: 'going-status', onClick: _this2.handleAddBarToMe.bind(_this2, bar) },
	                                    bar.userGoing === true ? 'Going' : 'GO!'
	                                )
	                            ),
	...
	function mapDispatchToProps(dispatch, ownProps) {
	    return {
	        removeBarFromMe: function removeBarFromMe(id) {
	            ...
	            dispatch((0, _actions.removeBarAJAX)(id));
	        }
	    };
	}
